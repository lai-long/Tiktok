...
func (p *kUserServiceClient) UserAvatar(ctx context.Context, Req *user.UserAvatarReq, callOptions ...callopt.Option) (r *user.UserAvatarResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UserAvatar(ctx, Req)
}
